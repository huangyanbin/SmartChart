...
public class ZoomChartListAdapter extends BaseQuickAdapter<String,BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, String item) {
       LineChart lineChart =  helper.getView(R.id.lineChart);
        ...
        tempList1.add(-40d);
        tempList1.add(10d);
        LineData columnData1 = new LineData("Temperature","℃", IAxis.AxisDirection.RIGHT,res.getColor(R.color.arc3),tempList1);
        ArrayList<Double> humidityList = new ArrayList<>();
        humidityList.add(60d);
        humidityList.add(50d);
        humidityList.add(30d);
        humidityList.add(65d);
        LineData columnData2 = new LineData("Humidity","RH%",res.getColor(R.color.arc2),humidityList);
