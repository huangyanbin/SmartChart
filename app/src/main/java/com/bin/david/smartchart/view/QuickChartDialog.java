...
import com.bin.david.smartchart.LineChartActivity;
...
public class QuickChartDialog {
    private Map<ChartStyle,BaseCheckDialog<String>> map;

    public QuickChartDialog(){
        map = new HashMap<>();
    }

    public   void showDialog(Activity activity,ChartStyle chartStyle,String[] dataList,OnCheckChangeAdapter adapter){
